...
# ── Data helpers ──────────────────────────────────────────────────────────────
from services.dashboard.data.mongodb_reader import fetch_latest_events
from services.dashboard.data.snowflake_reader import fetch_health_trends

# ── Components ────────────────────────────────────────────────────────────────
from services.dashboard.components.event_feed import render_event_feed
from services.dashboard.components.health_charts import render_health_chart
...
if "snowflake_error" not in st.session_state:
    st.session_state.snowflake_error = True
